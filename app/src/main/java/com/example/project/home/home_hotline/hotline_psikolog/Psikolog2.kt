...
class Psikolog2 : AppCompatActivity() {

    private lateinit var kembali: ImageView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_psikolog2)

        button()

        val tombolChat: View = findViewById(R.id.chat_p2)
    ...
    private fun button() {
        kembali = findViewById(R.id.back2)
